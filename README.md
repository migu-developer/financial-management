...
| **Observability** | CloudWatch (dashboard + 24 alarms + composite), EMF metrics, X-Ray tracing, SNS alerts |
...
| [Observability and Monitoring](docs/observability-flow.md)       | CloudWatch dashboard, 24 alarms + composite, EMF metrics, SNS alert pipeline, X-Ray   |
