...
| **Observability** | CloudWatch (dashboard + 28 alarms + composite), EMF metrics, X-Ray tracing, SNS alerts |
...
| [Observability and Monitoring](docs/observability-flow.md)       | CloudWatch dashboard, 28 alarms + composite, EMF metrics, SNS alert pipeline, X-Ray   |
