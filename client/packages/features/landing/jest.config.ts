...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    '^@features/landing$': '<rootDir>/src/index.ts',
    '^@features/landing/presentation/(.*)$': '<rootDir>/src/presentation/$1',
    // Mock React Native and native-only packages for node environment
