...
| Dropped                         | Why                                                                                                                                                                                                                                                                                                               |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Per-Lambda `Throttles`** (10) | Skipped on MEASURED grounds: 30 days of CloudWatch show 0 throttles and a peak of 3 of the account's 10 concurrent executions. A throttled invocation also surfaces as `Errors` on the function and 5xx on API Gateway, both still alarmed. See the note below — the account ceiling is 10, NOT the 1000 default. |
